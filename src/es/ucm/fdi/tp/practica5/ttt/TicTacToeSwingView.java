 ...
 * the new functionality that allow us to play Tic-Tac-Toe in swing.
 * <p>
 * Esta clase que extiende GenericSwingView añade a la clase abstracta la
 * nueva funcionalidad que permite jugar a Tic-Tac-Toe en swing.
 * <p>
 * 
...
public class TicTacToeSwingView extends ConnectNSwingView{
	 ...
	 *            IA (automaticos).
	 */
	public TicTacToeSwingView(Observable<GameObserver> g, Controller controller, Piece viewPiece, Player random, Player ai) {
